...
SET REPO_DOWNLOAD_URL=https://github.com/kandi1clickkits/build-your-own-chatgpt/releases/download/v1.0.0/build-your-own-chatgpt.zip
SET REPO_DEPENDENCIES_URL=https://github.com/kandi1clickkits/build-your-own-chatgpt/raw/main/requirements.txt
SET REPO_NAME=build-your-own-chatgpt.zip
SET EXTRACTED_REPO_DIR=build-your-own-chatgpt
SET NOTEBOOK_NAME=app.ipynb
SET GET_PIP_LOCATION=https://bootstrap.pypa.io/get-pip.py
SET VIRTUALENV_NAME=chatgpt-env
